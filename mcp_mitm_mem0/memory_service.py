...
class MemoryService:
    ...
    async def add_memory(
        ...
        try:
            self._logger.info("Adding memory", user_id=user_id, message_count=len(messages))
            ...
            self._logger.info("Memory added successfully", user_id=user_id, memory_id=result.get("id"))
            return result
    ...
    async def search_memories(
        ...
        try:
            ...
            self._logger.info("Search completed", user_id=user_id, result_count=len(results))
            return results
            
        except Exception as e:
            self._logger.error("Failed to search memories", user_id=user_id, error=str(e))
            raise
    ...
    async def get_all_memories(
        ...
        try:
            ...
            self._logger.info("Retrieved memories", user_id=user_id, memory_count=len(results))
            return results
    ...
    async def delete_memory(self, memory_id: str) -> dict[str, Any]:
        ...
        try:
            ...
            self._logger.error("Failed to delete memory", memory_id=memory_id, error=str(e))
            raise
    ...
    def add_memory_sync(
        ...
        try:
            self._logger.info("Adding memory (sync)", user_id=user_id, message_count=len(messages))
            ...
            self._logger.info("Memory added successfully (sync)", user_id=user_id, memory_id=result.get("id"))
            return result
            
        except Exception as e:
            self._logger.error("Failed to add memory (sync)", user_id=user_id, error=str(e))
            raise
    ...
    def search_memories_sync(
        ...
        try:
            self._logger.info("Searching memories (sync)", user_id=user_id, query=query[:50])
            ...
            self._logger.info("Search completed (sync)", user_id=user_id, result_count=len(results))
            return results
            
        except Exception as e:
            self._logger.error("Failed to search memories (sync)", user_id=user_id, error=str(e))
            raise
